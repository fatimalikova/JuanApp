...
namespace JuanApp.Data.Migrations
{
    ...
    [Migration("20260429163500_AddAllIdentityTables")]
    partial class AddAllIdentityTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("JuanApp.Models.AppUser")
                        .WithMany()
            ...
            modelBuilder.Entity("JuanApp.Models.ProductColor", b =>
                {
                    b.HasOne("JuanApp.Models.Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JuanApp.Models.Product")
